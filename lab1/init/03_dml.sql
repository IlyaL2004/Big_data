...
SELECT DISTINCT ON (c.customer_id, r.customer_pet_name)
    c.customer_id,
    r.customer_pet_name,
    pt.pet_type_id,
    pb.pet_breed_id,
...
JOIN dim_pet_type pt ON r.customer_pet_type = pt.type_name
JOIN dim_pet_breed pb ON r.customer_pet_breed = pb.breed_name
JOIN dim_pet_category pc ON r.pet_category = pc.category_name
